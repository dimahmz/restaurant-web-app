            ...
            <div className=" row-auto">
              <div className="flex flex-col">
                <div className="py-2 mb-4">
                  <div className="mb-1 w-[100%] bg-white rounded border border-solid ">
                    <div className=" ">
                      <div className="p-2">
                        <div className="row-auto">
                          <div className=" px-2 text-sm text-center ">
                            Demo login credentials
                            <div className="text-[#de222a]">
                  ...
                  <div className="mb-1 cursor-pointer bg-white   border border-solid rounded">
                    <div className="p-2 relative flex flex-col ">
                      <div className=" flex justify-between items-center">
                        <div className="w-[41.666%] px-2">
                          Admin: admin@mail.com
                        </div>
                        <div className="W-[33.333%] px-2">
                          password: khadyo@123
                        </div>
                        <div className="flex">
                          <span className="w-[25%] px-2 ">
                            <span> </span>
                            <button className=" px-2 py-1  text-white rounded-sm bg-[#f64e60]">
                              copy
                            </button>
                          </span>
                        </div>
