...
import data from "./permissiondata.json";
import { Link } from "react-router-dom";
import NewRoleGroups from "./AddNew/NewRoleGroups";
                                            ...
                                            <ul>
                                                {permissions.map(
                                                    (perm, idx) => (
                                                        <li
                                                            key={idx}
                                                            className=" py-2 m-2 bg-[#0dd19d] test-lg"
                                                        >
                                                            {perm}
                                                        </li>
                                                    )
                                                    ...
                                                    <ul>
                                                        {d.permissions.map(
                                                            (perm, idx) => (
                                                                <li
                                                                    key={idx}
                                                                    className=" py-2 m-2 bg-[#0dd19d] border rounded  text-black"
                                                                >
                                                                    {perm}
                                                                </li>
                                                            )
